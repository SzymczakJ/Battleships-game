...
public class RandomWhitePositions implements RandomizingStrategy{
    private Battlefield battlefield;
    private Random random = new Random();

    public RandomWhitePositions(Battlefield battlefield) {
